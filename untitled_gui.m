...
uicontrol("Units", "normalized", "Position", [0.785 0.92 0.10 0.07], "Style", "text", ...
          "FontSize", 15, "BackgroundColor", [1 0 1], "String", ...
          "Individual information:");

uicontrol("Units", "normalized", "Position", [0.69 0.87 0.10 0.04], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Birth Month: ")
...
uicontrol("Units", "normalized", "Position", [0.84 0.87 0.10 0.04], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Birth Year: ")
...
uicontrol("Units", "normalized", "Position", [0.64 0.79 0.13 0.07], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Claim retirement (Year): ")
...
uicontrol("Units", "normalized", "Position", [0.67 0.71 0.10 0.07], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Enter Death (Year): ")
...
uicontrol("Units", "normalized", "Position", [0.82 0.79 0.13 0.07], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Started Working (Year): ")
...
uicontrol("Units", "normalized", "Position", [0.82 0.71 0.12 0.07], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Ended Worked (Year): ")
...
uicontrol("Units", "normalized", "Position", [0.74 0.66 0.13 0.04], "Style", ...
          "text", "FontSize", 15, "BackgroundColor", [1 1 1], "String", "Monthly Income: ")
me_attribute_g = uicontrol('Units','normalized', 'BackgroundColor', ...
          [0 1 1], 'FontSize',15, 'ForegroundColor',[1 0 0], 'Position', ...
          [.87 .66 .06 .04], 'Style','edit', "Callback", "me.monthlyIncome = 0;," + ...
          "me.monthlyIncome = str2num(get(me_attribute_g, 'String'));");

is_sp = uicontrol("Units", "normalized", 'Style', 'checkbox', 'String', 'Has Spouse', ... 
        'Position', [0.89 0.59 0.2 0.05], "FontSize", 15, "Callback", ...
        ["if get(is_sp, 'Value') == 1, hasSpouse = true;, else, hasSpouse = false;, end"]);

uicontrol("Units", "normalized", "Position", [0.785 0.58 0.10 0.07], "Style", "text", ...
          "FontSize", 15, "BackgroundColor", [1 0 1], "String", ...
          "Spouse information:");
...
uicontrol("Units", "normalized", "Style", "text", "String", "Number of children: ", ...
          "BackgroundColor", [1 0 1], "FontSize", 15, "Position", [0.74 0.27 0.15 0.04])
num_child = uicontrol("Units", "normalized", "Style", "text", "String", "0", "BackgroundColor", [1 0 1], ...
            "FontSize", 17, "Position", [0.89 0.27 0.03 0.04]);
child_slider = uicontrol("Units", "normalized", "Style", "slider", "Position", [0.73 0.23 0.20 0.03], ...
               "Max", 3, "Min", 0, "Callback", ["save_child_num = round(get(child_slider, 'Value'));," + ...
               "set(num_child, 'String', num2str(save_child_num))"]);

uicontrol("Units", "normalized", "Style", "text", "String", "Child_1:", "BackgroundColor", ...
          [1 0 1], "FontSize", 15, "Position", [0.7 0.18 0.07 0.04]);
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(Y):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.77 0.18 0.07 0.04])
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(M):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.89 0.18 0.07 0.04])
child_aY = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.84 0.18 0.05 0.04], ...
          "FontSize", 15, "Callback", ["kids(1,1) = str2num(get(child_aY, 'String'));"]);
child_aM = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.96 0.18 0.04 0.04], ...
          "FontSize", 15, "Callback", ["kids(1,2) = str2num(get(child_aM, 'String'));"]);

uicontrol("Units", "normalized", "Style", "text", "String", "Child_2:", "BackgroundColor", ...
          [1 0 1], "FontSize", 15, "Position", [0.7 0.14 0.07 0.04]);
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(Y):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.77 0.14 0.07 0.04])
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(M):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.89 0.14 0.07 0.04])
child_bY = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.84 0.14 0.05 0.04], ...
          "FontSize", 15, "Callback", ["kids(2,1) = str2num(get(child_bY, 'String'));"]);
child_bM = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.96 0.14 0.04 0.04], ...
          "FontSize", 15, "Callback", ["kids(2,2) = str2num(get(child_bM, 'String'));"]);

uicontrol("Units", "normalized", "Style", "text", "String", "Child_3:", "BackgroundColor", ...
          [1 0 1], "FontSize", 15, "Position", [0.7 0.10 0.07 0.04]);
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(Y):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.77 0.10 0.07 0.04])
uicontrol("Units", "normalized", "Style", "text", "String", "Birth(M):", "BackgroundColor", ...
          [1 0 0], "FontSize", 15, "Position", [0.89 0.10 0.07 0.04])
child_cY = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.84 0.10 0.05 0.04], ...
          "FontSize", 15, "Callback", ["kids(3,1) = str2num(get(child_cY, 'String'));"]);
child_cM = uicontrol("Units", "normalized", "Style", "edit", "Position", [0.96 0.10 0.04 0.04], ...
          "FontSize", 15, "Callback", ["kids(3,2) = str2num(get(child_cM, 'String'));"]);

b = uicontrol("Units", "normalized", "Style", "pushbutton", "String", "Calculate", "FontSize", 15, "Position", [0.7 0.01 0.13 0.08],...
              "Callback", [...
              "if size(kids, 2) > 1 & save_child_num > 0, hasChildren = true;, else, hasChildren = false;, save_child_num = 0;, end," + ...
              "i = 1;, save_num = save_child_num;, children = [];," + ...
              "while save_num > 0, children = [children struct('birthY', kids(i, 1), 'birthM', kids(i, 2))];, i = i + 1;, save_num = save_num - 1;, end," + ...
              "[months, B_me, B_sp, B_kids, B_HH, S_HH] = untitled_updated(me, hasSpouse, sp, hasChildren, children);," + ...
              "untitled_gui,ax = axes('Units', 'normalized', 'Position', [0.04 0.62 0.6 0.35]);, plot(months, " + ...
              "B_me, 'LineWidth',1.3), hold on," + ...
              ...
              "ax = axes('Units', 'normalized', 'Position', [0.04 0.17 0.6 0.35]);, plot(months, S_HH, 'LineWidth',1.8), grid on," + ...
...
uicontrol("Units", "normalized", "Style","pushbutton","String", "Close", "Position", [0.85 0.01 0.13 0.08], ...
          "FontSize", 15, "Callback","clear, clc, close all")